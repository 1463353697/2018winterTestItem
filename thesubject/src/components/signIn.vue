<template>
    <div class="signIn">
        <div id="enterBlock">
            ...
            <div class="enterBody" >
                <input  type="text" placeholder="请输入用户名"  ><label></label>
    ...
    mounted:
        function(){
            ...
            signIn.onclick = function(){
                ...
                var theRequest = "http://hb9.api.okayapi.com/?s=App.User.Register&app_key=E0A52635859871C072A9B440A8352D61"
            +"&username="+username+"&password="+ pswMd5 ;
                
                if(userNameCheck  && psw1Check && psw2Check){
